    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align:center; margin-bottom:20px; color:#6c757d; font-size:0.9em;">
                <p>⏰ Автоматический экспорт выполняется в 9:00 UTC (12:00 MSK) по будням</p>
                <p>📅 Все временные метки отображаются в UTC</p>
                <p>🔄 При ошибках система автоматически повторит попытку до 3 раз с интервалом 5-15 минут</p>
            </div>
